...
module.exports = (app) => {
	...
	app.get("/rest/promises", (req, res) => {
		var output =
			...
			<a href="./promisesDB1">/promisesDB1</a> - Simple HANA DB Select via Promises</br>
			<a href="./promisesDB2">/promisesDB2</a> - Simple Database Call Stored Procedure via Promises</br>` +
