...
sap.ui.define([
	"sap/openSAP/odataBPTest/controller/BaseController",
	"sap/ui/model/json/JSONModel"
], function (BaseController, JSONModel) {
	"use strict";

	return BaseController.extend("sap.openSAP.odataBPTest.controller.App", {
		...
		callBPCreate: function () {
			...
			oEntry.address.validTo = new Date(2999, 12, 30).toJSON()
			oEntry.address.city = result.city;
			oEntry.address.country_code = this.getView().byId("ddlbCountry").getSelectedKey();
			oEntry.address.region = this.getView().byId("ddlbRegion").getSelectedKey();
			...
			oModel.create("/BusinessPartners", oEntry, mParams);
		}
