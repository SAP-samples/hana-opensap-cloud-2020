...
//	"sap/ui/thirdparty/sinon"
	...
	return UIComponent.extend("sap.openSAP.poListV4.Component", {
		metadata: {
			manifest: "json"
		},
		...
		createContent: function () {
			...
			View.create({
				async: true,
				bindingContexts: {
					undefined: oModel.createBindingContext("/POItems")
				},
				models: {
				...
				preprocessors: {
					xml: {
						bindingContexts: {
							data: oModel.createBindingContext("/POItems")
						},
						models: {
							data: oModel,
							meta: oMetaModel
				...
				type: ViewType.XML,
				viewName: "sap.openSAP.poListV4.view.Main"
			}).then(function (oView) {
