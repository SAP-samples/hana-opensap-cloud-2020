...
sap.ui.define([
	"sap/openSAP/odataCRUDV4/controller/BaseController",
	"sap/ui/model/json/JSONModel"
], function (BaseController, JSONModel) {
	"use strict"

	return BaseController.extend("sap.openSAP.odataCRUDV4.controller.App", {
			...
			try {
				...
				oContext.created().then(function () {
					sap.ui.require(["sap/m/MessageBox"], (MessageBox) => {
						MessageBox.alert("User created: " + oContext.getProperty("ID"))
					})
				}, function (oError) {
